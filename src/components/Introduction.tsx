...
const Introduction = () => {
  return (
    <div className="introduction-parent">
      <div className="introduction text-center shadow rounded-4 bg-white mb-5 p-5">
        <Heading>
          <>
            Introducing Decenode, a{" "}
        ...
        <p>
          ...
          developers through its decentralized P2P network, along with the
          benefit of optimized computation by leveraging distributed computing.
        </p>
      </div>
    </div>
  );
